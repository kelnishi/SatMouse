...
#ifndef SATMOUSE_SWIFT_H
#define SATMOUSE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SatMouse",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8SatMouse11AppDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC8SatMouse14ViewController")
