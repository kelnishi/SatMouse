 ...
 *
 * - WebSocket on config.wsPort (default 18945) — satmouse-json/satmouse-binary
 * - Legacy JSON on port 18944 — spacemouse-proxy compatible
 * - WebTransport on config.wtPort (default 18946)
 */
